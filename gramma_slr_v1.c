...
/* <cp> ::= '!=' */
char *Rule_cp_ExclamEq(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 1 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <cp> ::= '==' */
char *Rule_cp_EqEq(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 1 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <cp> ::= '<' */
char *Rule_cp_Lt(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 1 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <cp> ::= '>' */
char *Rule_cp_Gt(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 1 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <r> ::= <r> <ar> <t> */
char *Rule_r(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 3 */
  struct TokenStruct *TokenArg;
  char *Value;
...
/* <r> ::= <t> */
char *Rule_r2(struct TokenStruct *Token, int Debug, int Indent) {
  /* Arguments: 1 */
  struct TokenStruct *TokenArg;
  char *Value;
...
char *(*RuleJumpTable[])(struct TokenStruct *Token, int Debug, int Indent) = {
  ...
  /* 37. <function> ::= FUNCTION ID '(' <param> <stm> */
